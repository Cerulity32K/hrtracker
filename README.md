...
- `hrtracker list`: Lists all schedules.
- `hrtracker when name`: Queries when the next event is scheduled for the schedule with the given `name`.
- `hrtracker next name`: Adds the interval of schedule `name` to its date.
